...
const Signin = () => {
  ...
  return (
    <div class=" flex items-center gap-8 flex-col " >
      <div class=" mt-4 cursor-pointer" onClick={()=>{
        navigate('/')
      }}>
        ...
        <div class=" flex flex-col w-1/2  bg-white gap-3">
          ...
          <div class="flex flex-col gap-1">
            <button class="flex items-center justify-center  gap-2 bg-blue-600 w-full p-2.5 rounded-md">
              <img
                class=""
                src="https://img.icons8.com/material-sharp/30/ffffff/google-logo.png"
                alt="google"
              />
          ...
          <div>
            <div class="flex flex-col gap-4 ">
              <form class="flex flex-col gap-4 ">
                <div class="flex flex-col gap-2">
                  ...
                  <div class="flex border-2 border-slate-600 rounded-md w-full items-center">
                    <div class="flex items-center  ml-2">
                      ...
                      <input
                        class="p-2.5 text-gray-600 outline-none w-96  "
                        type="text"
                ...
                <div class="flex flex-col gap-2">
                  <span class="text-slate-600 text-1xl font-bold">
                    Password
                  </span>
                  <div class="flex border-2 border-slate-600 rounded-md w-full items-center ">
              ...
              <div class="flex justify-center gap-2 mb-4">
                <span class="cursor-pointer" onClick={handleChange}>
