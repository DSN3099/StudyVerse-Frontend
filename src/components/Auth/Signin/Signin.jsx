  ...
  return (
    <div class=' flex items-center gap-8 flex-col '>
      ...
      <div class=' flex justify-center w-full h-full'>
        <div class=' flex flex-col w-1/2  bg-white gap-3'>
          <div class='flex  '>
                ...
                <div class='flex flex-col gap-2'>
                  ...
                  <div class='flex border-2 border-slate-600 rounded-md w-full items-center'>
                    <div class='flex items-center  ml-2'>
                      ...
                      <input class='p-2.5 text-gray-600 outline-none w-96  ' type="text" placeholder='Enter your Email' />
                    </div>
                  </div>
                </div>
                <div class='flex flex-col gap-2'>
                  ...
                  <div class='flex border-2 border-slate-600 rounded-md w-full items-center '>
                    <div class='flex items-center justify-between w-full ml-2'>
                      <div class='flex items-center '>
                        ...
                        <input class='p-2.5 text-gray-600 outline-none w-96 ' type={seepassword ? 'text' : 'password'} placeholder='Enter your Password' />
                      </div>
                      <div class='pr-1' onClick={() => { setSeepassword(!seepassword) }}>{!seepassword ? <VisibilityOffIcon /> : <VisibilityIcon  />}</div>
                    </div>
                  </div>
                </div>
              </form>
