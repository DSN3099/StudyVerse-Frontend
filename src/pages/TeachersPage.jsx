  ...
  return (
    <div className="main">
      ...
      <div className="course-creation flex justify-between items-center  bg-white-100 shadow-lg shadow-slate-300 p-11 m-24">
        <h1 className=" text-4xl font-bold">Jump Into Course Creation</h1>
        <button className="text-4xl font-medium bg-blue-600 p-7 rounded-md text-white">
          Create Your Course
        </button>
      </div>
      ...
      <div className="course-creation flex bg-white-100 shadow-lg shadow-slate-300 rounded-md justify-evenly items-center  p-11 m-24">
        ...
        <div className="gap-5 flex  flex-col mb-24 w-1/2  p-5">
          <h1 className="text-4xl font-medium ">Create an Engaging Course</h1>
      ...
      <div className='text-center m-11'>
        <h1 className='text-2xl font-semibold'>Have Questions? Here are our most popular instructor resources</h1>
      </div>
      {/* footer */}
      <Footer/>
    </div>
