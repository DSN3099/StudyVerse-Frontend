      ...
      <div class=" flex justify-between border-2 border-dashed border-slate-300  rounded-md">
        <div class="flex flex-1 items-center justify-center w-full">
          <div class="flex flex-col gap-5 items-center w-1/2">
            <div class="flex flex-col gap-2 items-center">
              <span class="text-4xl mb-10 font-semibold ">
                {coursedata?.title}
              </span>
              <span class="text-[22px] font-bold text-[#292929]">
                Upload the videos
              </span>
        ...
        <div class="flex flex-1 p-3 w-full">
          <div class="flex flex-col gap-5 w-full">
            <span class="text-[#A0A0A0] text-[14px]  font-[400]">
              Uploaded Files
            </span>
            <div class="flex flex-col gap-3 overflow-y-auto h-[550px]">
              {fileupload.map((values, i) => (
                <div
                  class="border-2 border-[#698AFF] p-2 rounded-md "
                  onClick={() => {
                    setEditid(values.id)
                  }}
                >
