...
const Card = ({title,course,rating,level,img,price,id}) => {
  ...
  return (
    <div class="flex flex-col bg-white-300 h-max w-64 rounded-md gap-2.5 border border-slate-500 shadow-lg shadow-teal-500/40  transform transition duration-500 hover:scale-[0.9] cursor-pointer" onClick={()=>{navigate(`/video/${id}`)}}>
